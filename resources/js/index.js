...
let createAccordion = (title, id) => {
  return `
  <div class="accodion-item accordion card pb-3" id="card${id}">
...
let createCarouselOuter = (id, innerId) => {
  return `
  <div id="carouselControls${id}" class="carousel slide" data-bs-ride="carousel" data-interval="false">
...
let createCard = (item) => {
  ...
  <div class="card d-block">
    ...
    <div class="card-body">
      ...
      <p class='' style="font-size:18px;"><span style='color: #d39e008f;'>${item.author}  </span>•  ${(item.pubDate).split(' ')[0]}</p>
                <hr></hr>
